...
int main() {
        ...
        printf("2222 \n");
          ...
          fft_id = 1;
              ...
              */
              ...
              std::cout << "Time difference t1 = " << std::chrono::duration_cast<std::chrono::nanoseconds> (t1 - t0).count() << "[ns]" << std::endl;
  ...
  printf("[wifi] Execution is complete...,%f \n", time_taken);
...
void readConfig() {
    ...
    cfp = fopen("/home/lchang21/cedr-josh/zynq_hardware_emulator/applications/APIApps/wifi-tx/src/input/tx.cfg", "r");
    if(cfp == NULL) {
